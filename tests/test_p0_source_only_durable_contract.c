...
#define COLLECTOR_EVIDENCE_FIXTURE_CASES 14u
...
static const SourceFixtureCase k_collector_evidence_cases[COLLECTOR_EVIDENCE_FIXTURE_CASES] = {
    ...
    {EDR_EVENT_FILE_READ, "filemeta-actor-image-0001", "", EDR_P0_FILE_READ_REASON_ACTOR_IMAGE_UNRESOLVED},
    {EDR_EVENT_FILE_READ, "filemeta-deferred-full-0001", "", EDR_P0_FILE_READ_REASON_DEFERRED_CAPACITY},
    {EDR_EVENT_FILE_READ, "filemeta-deferred-timeout-0001", "", EDR_P0_FILE_READ_REASON_DEFERRED_TIMEOUT},
    {EDR_EVENT_FILE_READ, "filemeta-deferred-stop-0001", "", EDR_P0_FILE_READ_REASON_DEFERRED_SHUTDOWN},
};
