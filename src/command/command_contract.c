...
static const CommandFieldRule k_rtq_rules[] = {
    ...
    RULE("process_user", FIELD_STRING, 0, 0, 0, 512, 0),
    RULE("process_pid_min", FIELD_NUMBER, 0, 0, 4294967295.0, 0, 0),
    RULE("process_pid_max", FIELD_NUMBER, 0, 1, 4294967295.0, 0, 0),
    RULE("network_remote_ip", FIELD_STRING, 0, 0, 0, 128, 0),
    RULE("network_remote_port", FIELD_NUMBER, 0, 1, 65535, 0, 0),
    RULE("network_state", FIELD_STRING, 0, 0, 0, 64, 0),
    RULE("network_proto", FIELD_STRING, 0, 0, 0, 16, 0),
    RULE("file_path", FIELD_STRING, 0, 0, 0, 4096, 0),
    RULE("file_sha256", FIELD_STRING, 0, 0, 0, 64, 0),
    RULE("file_ext", FIELD_STRING, 0, 0, 0, 64, 0),
    RULE("registry_path", FIELD_STRING, 0, 0, 0, 4096, 0),
    RULE("registry_value", FIELD_STRING, 0, 0, 0, 512, 0),
    RULE("registry_mode", FIELD_STRING, 0, 0, 0, 16, 0),
    RULE("eventlog_channel", FIELD_STRING, 0, 0, 0, 256, 0),
    RULE("eventlog_query", FIELD_STRING, 0, 0, 0, 4096, 0),
    RULE("script_content", FIELD_STRING, 0, 0, 0, 4096, 0),
    RULE("script_engine", FIELD_STRING, 0, 0, 0, 128, 0),
};
