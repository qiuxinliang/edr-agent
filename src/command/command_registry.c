...
static const EdrCommandAlias k_commands[] = {
    ...
    COMMAND("agent_restart_service", EDR_COMMAND_KIND_AGENT_RESTART_SERVICE,
            "agent_restart_service",
            EDR_COMMAND_FLAG_DANGEROUS | EDR_COMMAND_FLAG_OPERATOR_ONLY,
            EDR_COMMAND_PAYLOAD_ENDPOINT_LIFECYCLE),
    COMMAND("agent_offboard", EDR_COMMAND_KIND_AGENT_OFFBOARD, "agent_offboard",
            EDR_COMMAND_FLAG_DANGEROUS | EDR_COMMAND_FLAG_OPERATOR_ONLY,
            EDR_COMMAND_PAYLOAD_ENDPOINT_LIFECYCLE),
    COMMAND("agent_uninstall", EDR_COMMAND_KIND_AGENT_UNINSTALL, "agent_uninstall",
            EDR_COMMAND_FLAG_DANGEROUS | EDR_COMMAND_FLAG_OPERATOR_ONLY,
            EDR_COMMAND_PAYLOAD_ENDPOINT_LIFECYCLE),
